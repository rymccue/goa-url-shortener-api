...
import (
	...
	"github.com/rymccue/goa-url-shortener-api/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "URL Shortener API-cli",
		Short: `CLI client for the URL Shortener API service`,
	}
	...
	c.UserAgent = "URL Shortener API-cli/0"
